...
- If a question is company-specific (e.g., "asked at Illumina"), you may note it, but write the answer generically so it's useful to everyone.
- Cite sources for any specific statistics, benchmark numbers, or regulatory claims.
- Flag when a technique, tool, or best practice is evolving quickly (this field moves fast — reference genomes, variant databases, and analysis standards get updated) so readers know to verify against current documentation.
- Avoid stating clinical/diagnostic claims about specific genetic variants as settled fact; note when something is an active area of research or database-dependent (e.g., ClinVar classifications can change over time).
...
Be kind. Many contributors and readers are early in their careers or transitioning between computational and wet-lab/biology backgrounds — write answers you'd have wanted when you were starting out.
